                  ...
                  <Grid container>
                    ...
                    <Grid item md={6}>
                      <span className=" text-xs text-cd6d5">
                        Exploring Love, Romans, Relationship issues, Drama,
                        Sensual world, Comedy, Healing & Erotic Shows,
                      </span>
                    </Grid>
                  </Grid>
                </div>
                <div className="footer_widget__middle flex flex-wrap  items-center">
                  ...
                  <div className="footer_widget__middle_right w-1/2 text-right">
                    <Box className="social_widget__bar inline-flex items-center justify-start">
                      <Link href="/">
                        <a
                          className={`${classes.socialIcon} bg-cc4c4 h-8 w-8 inline-flex rounded-full shadow-xl items-center justify-center`}
                        >
                          <Image
                            loader={ImageLoader}
                      ...
                      <Link href="/">
                        <a
                          className={` ${classes.socialIcon} bg-cc4c4 ml-3 h-8 w-8 inline-flex rounded-full shadow-xl items-center justify-center`}
                        >
                          <Image
                            loader={ImageLoader}
            ...
            <Grid item md={3}>
              <Box className=" pl-12 border-l-2  border-l-slate-200 h-full">
                ...
                <Box className="social_widget__bar inline-flex items-center justify-start">
                  <Link href="/">
                    <a
                      className={`${classes.socialIcon} h-8 w-8 inline-flex rounded-full shadow-xl items-center justify-center`}
                    >
                      <Image
                        loader={ImageLoader}
                        src="images/facebook-1.svg"
                  ...
                  <Link href="/">
                    <a
                      className={` ${classes.socialIcon} ml-3 h-8 w-8 inline-flex rounded-full shadow-xl items-center justify-center`}
                    >
                      <Image
                        loader={ImageLoader}
                        src="images/instagram-1.svg"
                  ...
                  <Link href="/">
                    <a
                      className={` ${classes.socialIcon} ml-3 h-8 w-8 inline-flex rounded-full  items-center justify-center`}
                    >
                      <Image
                        loader={ImageLoader}
